...
- [2.8.2.30 - Bug Fix & Enhancement Release](#28230---bug-fix--enhancement-release)
    ...
    - [Drag & Drop, Paste](#drag--drop-paste)
    - [Actions](#actions)
...
* [ ] Add: Markdown To Do tool window and show task list items in it. See if to do window can be
      extended.
  * [ ] Task List index to application so these can be located quickly. Stub needs text,
        done/not done status.
  * [ ] Show task items in hierarchy with their child task items
  * [ ] Allow drag/drop in the tree view to move items with all their children between headings
        and between files.
* [ ] Add: link and # link Ref search dialog similar to search in files but geared towards
      finding links.
...
* [ ] Add: delete identical duplicated references without questions all the time. Add to
      ...
      definition.
* [ ] Fix: inserting characters before or between block quote markers does not work `>`
