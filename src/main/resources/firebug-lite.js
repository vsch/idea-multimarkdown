...
if(document.documentElement.getAttribute("debug")=="true" || true){FBL.Env.Options.startOpened=true
}findLocation();
...
}}if(Env.browser.document.documentElement.getAttribute("debug")=="true" || true){Env.Options.startOpened=true
