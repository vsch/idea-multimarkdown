...
public interface MultiMarkdownTypes {
    ...
    IElementType IMAGE_LINK_REF_TEXT_OPEN = new MultiMarkdownTokenType("IMAGE_LINK_REF_TEXT_OPEN");
    IElementType IMAGE_LINK_REF_TEXT_CLOSE = new MultiMarkdownTokenType("IMAGE_LINK_REF_TEXT_CLOSE");
    ...
    // parsable and instantiatable Element types
    ...
    IElementType IMAGE_LINK_REF = new MultiMarkdownElementType("IMAGE_LINK_REF");
    IElementType IMAGE_LINK_REF_TITLE = new MultiMarkdownElementType("IMAGE_TITLE");
    IElementType IMAGE_LINK_REF_TEXT = new MultiMarkdownElementType("IMAGE_LINK_TEXT");

    IElementType EXPLICIT_LINK = new MultiMarkdownElementType("EXPLICIT_LINK");
    IElementType LINK_REF = new MultiMarkdownElementType("LINK_REF");
    IElementType LINK_REF_TEXT = new MultiMarkdownElementType("LINK_REF_TEXT");
    IElementType LINK_REF_TITLE = new MultiMarkdownElementType("LINK_REF_TITLE");
    IElementType LINK_REF_ANCHOR = new MultiMarkdownElementType("LINK_REF_ANCHOR");
