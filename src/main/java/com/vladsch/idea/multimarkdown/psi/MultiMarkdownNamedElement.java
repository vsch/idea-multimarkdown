...
public interface MultiMarkdownNamedElement extends PsiNameIdentifierOwner, Navigatable {
    ...
    int REASON_FILE_RENAMED = RENAME_KEEP_PATH | RENAME_KEEP_ANCHOR | RENAME_KEEP_RENAMED_TEXT | RENAME_KEEP_TEXT | RENAME_KEEP_TITLE;
    int REASON_FILE_MOVED = RENAME_KEEP_ANCHOR | RENAME_KEEP_RENAMED_TEXT | RENAME_KEEP_TEXT | RENAME_KEEP_TITLE;
