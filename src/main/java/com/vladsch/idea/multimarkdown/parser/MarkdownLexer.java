...
public class MarkdownLexer extends Lexer {
    ...
    private static final Logger LOGGER = Logger.getInstance(MarkdownLexer.class);
    protected MarkdownLexParser lexParser = null;
    protected int startOffset = 0;
    protected int endOffset = 0;
    protected int lexemeIndex = 0;
    protected int currentOffset = 0;
    protected CharSequence buffer = null;
    protected MarkdownLexParser.LexerToken lexerToken = null;
    protected MarkdownLexParser.LexerToken[] lexerTokens = null;

    public MarkdownLexer() {
        super();

        lexParser = new MarkdownLexParser();
    }
