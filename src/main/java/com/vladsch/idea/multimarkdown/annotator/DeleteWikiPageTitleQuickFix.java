...
class DeleteWikiPageTitleQuickFix extends BaseIntentionAction {
    private MultiMarkdownWikiLink wikiLinkElement;

    DeleteWikiPageTitleQuickFix(MultiMarkdownWikiLink wikiLinkElement) {
    ...
    public String getText() {
        return MultiMarkdownBundle.message("quickfix.wikilink.delete-page-title");
    }
    ...
    private void deleteWikiPageRefTitle(final Project project, final MultiMarkdownWikiLink wikiLinkElement) {
        new WriteCommandAction.Simple(project) {
            ...
            public void run() {
                ...
                if (wikiLinkElement.isValid()) MultiMarkdownPsiImplUtil.deleteWikiLinkTitle(wikiLinkElement);
            }
        }.execute();
    }
}
