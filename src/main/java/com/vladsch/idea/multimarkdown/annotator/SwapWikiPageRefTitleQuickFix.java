...
class SwapWikiPageRefTitleQuickFix extends BaseIntentionAction {
    ...
    SwapWikiPageRefTitleQuickFix(MultiMarkdownWikiLink wikiLinkElement) {
    ...
    public String getText() {
        return MultiMarkdownBundle.message("quickfix.wikilink.swap-page-ref-title");
    }
    ...
    public void invoke(@NotNull final Project project, final Editor editor, final PsiFile file) throws IncorrectOperationException {
        ApplicationManager.getApplication().invokeLater(new Runnable() {
            @Override
            public void run() {
                swapWikiPageRefTitle(project, wikiLinkElement);
            }
        });
    }

    private void swapWikiPageRefTitle(final Project project, final MultiMarkdownWikiLink wikiLinkElement) {
