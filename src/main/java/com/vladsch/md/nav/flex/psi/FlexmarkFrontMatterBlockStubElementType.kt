...
class FlexmarkFrontMatterBlockStubElementType(debugName: String) : MdPlainTextStubElementType<FlexmarkFrontMatterBlock, FlexmarkFrontMatterBlockStub>(debugName) {
    ...
    override fun createPsi(stub: FlexmarkFrontMatterBlockStub): FlexmarkFrontMatterBlock = FlexmarkFrontMatterBlockImpl(stub, this)
    override fun getExternalId(): String = "markdown.plain-text-referenceable.flexmark-front-matter"
    override fun createStub(parentStub: StubElement<*>, textMapType: TextMapElementType, textMapMatches: Array<TextMapMatch>, referenceableOffsetInParent: Int): FlexmarkFrontMatterBlockStub = FlexmarkFrontMatterBlockStubImpl(parentStub, textMapType, textMapMatches, referenceableOffsetInParent)
