...
object SwingHtmlCssResource : HtmlCssResource(SwingHtmlCssProvider.INFO
    ...
    override fun injectHtmlResource(project: Project, applicationSettings: MdApplicationSettings, renderingProfile: MdRenderingProfile, injections: ArrayList<InjectHtmlResource?>, forHtmlExport: Boolean, dataContext: DataContext) {
        ...
        val scale = Math.round(11.0 * renderingProfile.previewSettings.zoomFactor * applicationSettings.documentSettings.zoomFactor).toInt()
        injectCSSText(injections, true, true, false, """
