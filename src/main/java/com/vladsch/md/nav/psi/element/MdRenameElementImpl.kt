...
abstract class MdRenameElementImpl(node: ASTNode) : ASTWrapperPsiElement(node), MdRenameElement {
    ...
    override fun handleContentChange(newContent: String): MdRenameElement {
        return setName(newContent, MdRenameElement.REASON_FILE_RENAMED) as MdRenameElement
    }
