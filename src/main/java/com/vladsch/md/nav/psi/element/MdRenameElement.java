...
public interface MdRenameElement extends MdPsiElement, NavigationItem, MdStructureViewPresentableItem {
    ...
    MdRenameElement handleContentChange(@NotNull TextRange range, @NotNull String newContent) throws IncorrectOperationException;

    MdRenameElement handleContentChange(@NotNull String newContent) throws IncorrectOperationException;
