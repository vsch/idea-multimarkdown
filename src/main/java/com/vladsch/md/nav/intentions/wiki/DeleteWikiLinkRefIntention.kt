...
class DeleteWikiLinkRefIntention : Intention() {
    ...
    override fun processIntention(element: PsiElement, project: Project, editor: Editor, editContext: PsiEditContext) {
        ...
        MdPsiImplUtil.deleteWikiLinkRef(element)
    }
    ...
    companion object : Intention.IntentionCompanion(DeleteWikiLinkRefIntention::class.java)
}
