...
class MdEnumeratedReferenceTextImpl(node: ASTNode) : MdEnumeratedReferenceBaseImpl(node), MdEnumeratedReferenceText {
    ...
    override fun getTextChildType(): IElementType {
        ...
        //return MultiMarkdownTypes.ENUM_REF_ID
    }

    companion object {
        private val STRING_NAME = "ENUMERATED_REFERENCE_TEXT"
