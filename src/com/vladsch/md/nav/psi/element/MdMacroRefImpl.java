...
public class MdMacroRefImpl extends MdReferencingElementImpl implements MdMacroRef {
    protected static final String STRING_NAME = "MACRO_REFERENCE";

    public static String getElementText(@NotNull MdFactoryContext factoryContext, @NotNull String referenceId) {
        return "<<<" + referenceId + ">>>";
    }

    public MdMacroRefImpl(@NotNull ASTNode node) {
        super(node);
    }
