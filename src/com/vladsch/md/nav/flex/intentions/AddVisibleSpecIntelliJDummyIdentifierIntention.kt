...
class AddVisibleSpecIntelliJDummyIdentifierIntention : InsertOrReplaceCaretTextIntention() {

    override fun getText(element: PsiElement, documentChars: CharSequence, selectionStart: Int, selectionEnd: Int): String {
        return TestUtils.toVisibleSpecText(com.vladsch.plugin.util.TestUtils.DUMMY_IDENTIFIER)
    }
