...
import static com.vladsch.md.nav.testUtil.TestCaseUtils.assertSuggestionEquals;
...
public class TestSuggestionFixersBasic extends TestCase {
    ...
    /* @formatter:off */
    @Test
    public void testSuggestCleanSpacedWords() { assertSuggestionEquals(suggestion, SuggestCleanSpacedWords, SuggestionFixers.SuggestCleanSpacedWords); }

    @Test
    public void testSuggestCapSpacedWords() { assertSuggestionEquals(suggestion, SuggestCapSpacedWords, SuggestionFixers.SuggestCapSpacedWords); }

    @Test
    public void testSuggestLowerSpacedWords() { assertSuggestionEquals(suggestion, SuggestLowerSpacedWords, SuggestionFixers.SuggestLowerSpacedWords); }

    @Test
    public void testSuggestUpperSpacedWords() { assertSuggestionEquals(suggestion, SuggestUpperSpacedWords, SuggestionFixers.SuggestUpperSpacedWords); }

    @Test
    public void testSuggestCleanSplicedWords() { assertSuggestionEquals(suggestion, SuggestCleanSplicedWords, SuggestionFixers.SuggestCleanSplicedWords); }

    @Test
    public void testSuggestCapSplicedWords() { assertSuggestionEquals(suggestion, SuggestCapSplicedWords, SuggestionFixers.SuggestCapSplicedWords); }

    @Test
    public void testSuggestLowerSplicedWords() { assertSuggestionEquals(suggestion, SuggestLowerSplicedWords, SuggestionFixers.SuggestLowerSplicedWords); }

    @Test
    public void testSuggestUpperSplicedWords() { assertSuggestionEquals(suggestion, SuggestUpperSplicedWords, SuggestionFixers.SuggestUpperSplicedWords); }

    @Test
    public void testSuggestCleanDashedWords() { assertSuggestionEquals(suggestion, SuggestCleanDashedWords, SuggestionFixers.SuggestCleanDashedWords); }

    @Test
    public void testSuggestCapDashedWords() { assertSuggestionEquals(suggestion, SuggestCapDashedWords, SuggestionFixers.SuggestCapDashedWords); }

    @Test
    public void testSuggestLowerDashedWords() { assertSuggestionEquals(suggestion, SuggestLowerDashedWords, SuggestionFixers.SuggestLowerDashedWords); }

    @Test
    public void testSuggestUpperDashedWords() { assertSuggestionEquals(suggestion, SuggestUpperDashedWords, SuggestionFixers.SuggestUpperDashedWords); }

    @Test
    public void testSuggestCleanSnakedWords() { assertSuggestionEquals(suggestion, SuggestCleanSnakedWords, SuggestionFixers.SuggestCleanSnakedWords); }

    @Test
    public void testSuggestCapSnakedWords() { assertSuggestionEquals(suggestion, SuggestCapSnakedWords, SuggestionFixers.SuggestCapSnakedWords); }

    @Test
    public void testSuggestLowerSnakedWords() { assertSuggestionEquals(suggestion, SuggestLowerSnakedWords, SuggestionFixers.SuggestLowerSnakedWords); }

    @Test
    public void testSuggestUpperSnakedWords() { assertSuggestionEquals(suggestion, SuggestUpperSnakedWords, SuggestionFixers.SuggestUpperSnakedWords); }

    @Test
    public void testSuggestWikiRefAsFilNameWithExt() { assertSuggestionEquals(suggestion, SuggestWikiRefAsFilNameWithExt, SuggestionFixers.SuggestWikiRefAsFilNameWithExt); }

    @Test
    public void testSuggestFileNameWithExt() { assertSuggestionEquals(suggestion, SuggestFileNameWithExt, SuggestionFixers.SuggestFileNameWithExt); }
    /* @formatter:on */
