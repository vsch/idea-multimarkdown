...
import static com.vladsch.md.nav.testUtil.TestCaseUtils.compareOrderedLists;
...
public class TestSuggestionListFixers {
    ...
    private static final Suggestion.Fixer fixer1 = new SuggestionFixers.FixerBase() {
        @Override
    ...
    private static final Suggestion.Fixer fixer2 = new SuggestionFixers.FixerBase() {
        @Override
        public void makeSuggestions(@NotNull String text, @NotNull Suggestion suggestion, Project project) {
    ...
    private static final Suggestion.Fixer fixer3 = new SuggestionFixers.FixerBase() {
        @Override
        public void makeSuggestions(@NotNull String text, @NotNull Suggestion suggestion, Project project) {
    ...
    private static final Suggestion.Fixer nullFixer = (suggestion, project) -> null;
