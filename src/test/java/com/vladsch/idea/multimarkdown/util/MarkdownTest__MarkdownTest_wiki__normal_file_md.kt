    ...
    companion object {
        ...
        fun mismatchInfo(): Collection<Array<Any?>> {
            ...
            val data = arrayListOf<Array<Any?>>(
                ...
                /* 18 */arrayOf<Any?>(37       , "ID_LINK_TARGETS_WIKI_HAS_EXT"    , Severity.WARNING     , ""                             , null) /* 18 */,
                /* 19 */arrayOf<Any?>(44       , "ID_LINK_TARGETS_WIKI_HAS_EXT"    , Severity.WARNING     , ""                             , null) /* 19 */,
                /* 20 */arrayOf<Any?>(46       , "ID_TARGET_NAME_HAS_ANCHOR"       , Severity.WARNING     , null                           , "anchor-in-name5.md") /* 20 */,
                /* 21 */arrayOf<Any?>(47       , "ID_LINK_TARGETS_WIKI_HAS_EXT"    , Severity.WARNING     , "anchor-in-name%235"           , null) /* 21 */,
                /* 22 */arrayOf<Any?>(47       , "ID_TARGET_NAME_HAS_ANCHOR"       , Severity.WARNING     , null                           , "anchor-in-name5.md") /* 22 */,
                /* 23 */arrayOf<Any?>(48       , "ID_TARGET_NAME_HAS_ANCHOR"       , Severity.WARNING     , null                           , "anchor-in-name5.md") /* 23 */,
                /* 24 */arrayOf<Any?>(49       , "ID_TARGET_NAME_HAS_ANCHOR"       , Severity.WARNING     , null                           , "anchor-in-name5.md") /* 24 */,
                /* 25 */arrayOf<Any?>(55       , "ID_LINK_TARGETS_WIKI_HAS_EXT"    , Severity.WARNING     , "In-Name"                      , null) /* 25 */,
                /* 26 */arrayOf<Any?>(57       , "ID_LINK_TARGETS_WIKI_HAS_EXT"    , Severity.WARNING     , "In-Name"                      , null) /* 26 */,
                /* 27 */arrayOf<Any?>(64       , "ID_CASE_MISMATCH"                , Severity.ERROR       , "../blob/master/NonWikiFile.md", "../nonwikiFile.md") /* 27 */,
