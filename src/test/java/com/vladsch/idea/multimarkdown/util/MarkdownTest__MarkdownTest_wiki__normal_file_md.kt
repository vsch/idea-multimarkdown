    ...
    companion object {
        ...
        fun data(): Collection<Array<Any?>> {
            ...
            val data = arrayListOf<Array<Any?>>(
                ...
                /* 73 */arrayOf<Any?>("/Users/vlad/src/MarkdownTest/MarkdownTest.wiki/normal-file.md", ::FileLinkRef , "Space In Name"         , "Space%20In%20Name"                          , null        , null       , "Space In Name.md"                    , "Space In Name.md"                    , "Space%20In%20Name"                 , arrayOf<String>()) /* 73 */,
                /* 74 */arrayOf<Any?>("/Users/vlad/src/MarkdownTest/MarkdownTest.wiki/normal-file.md", ::FileLinkRef , "test.kt"               , "test.kt"                                    , null        , null       , null                                  , null                                  , null                                , arrayOf<String>("Test.kt")) /* 74 */,
                /* 75 */arrayOf<Any?>("/Users/vlad/src/MarkdownTest/MarkdownTest.wiki/normal-file.md", ::FileLinkRef , "Normal-File"           , "Normal-File"                                , null        , null       , "normal-file.md"                      , "normal-file.md"                      , "#"                                 , arrayOf<String>()) /* 75 */,
                /* 76 */arrayOf<Any?>("/Users/vlad/src/MarkdownTest/MarkdownTest.wiki/normal-file.md", ::FileLinkRef , "Normal-File.md"        , "Normal-File.md"                             , null        , null       , null                                  , null                                  , null                                , arrayOf<String>("normal-file.md")) /* 76 */
                /* @formatter:on */
            )
