    ...
    companion object {
        ...
        fun data(): Collection<Array<Any?>> {
            ...
            val data = arrayListOf<Array<Any?>>(
                ...
                /* 46 */arrayOf<Any?>("/Users/vlad/src/MarkdownTest/MarkdownTest.wiki/normal-file.md", ::LinkRef , "anchor in name#5"      , "anchor-in-name"                             , "5"         , null       , "anchor-in-name#5.md"                 , "anchor-in-name#5.md"                 , "anchor-in-name%235"                , arrayOf<String>()) /* 46 */,
                /* 47 */arrayOf<Any?>("/Users/vlad/src/MarkdownTest/MarkdownTest.wiki/normal-file.md", ::LinkRef , "anchor in name#5"      , "anchor-in-name"                             , "5.md"      , null       , "anchor-in-name#5.md"                 , "anchor-in-name#5.md"                 , "anchor-in-name%235.md"             , arrayOf<String>()) /* 47 */,
                ...
                /* 61 */arrayOf<Any?>("/Users/vlad/src/MarkdownTest/MarkdownTest.wiki/normal-file.md", ::LinkRef , "Non Wiki File"         , "../NonWikiFile"                             , null        , null       , null                                  , null                                  , null                                , arrayOf<String>()) /* 61 */,
