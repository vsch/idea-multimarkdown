...
public class BackspaceHandlerNoWrapSpecTest extends MdEnhLightPlatformActionSpecTestCase {
    private static final String SPEC_RESOURCE = "backspace_handler_no_wrap_spec_test.md";
    public static final ResourceLocation RESOURCE_LOCATION = ResourceLocation.of(BackspaceHandlerNoWrapSpecTest.class, SPEC_RESOURCE);

    public BackspaceHandlerNoWrapSpecTest() {
        super(null);
    }
    ...
    public ActionSpecRenderer<?> createExampleSpecRenderer(@NotNull SpecExample example, @Nullable DataHolder options) {
        ...
        return super.createExampleSpecRenderer(example, appendDefaultExampleOptions(example, options, "no-wrap, backspace"));
    }
}
