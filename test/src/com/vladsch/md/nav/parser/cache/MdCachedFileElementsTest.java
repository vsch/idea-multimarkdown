...
public class MdCachedFileElementsTest extends MdLightPlatformActionSpecTestCase implements MdCachedFileElementsTestCase {
    private static final String SPEC_RESOURCE = "file_element_stash_spec_test.md";
    public static final ResourceLocation RESOURCE_LOCATION = ResourceLocation.of(MdCachedFileElementsTest.class, SPEC_RESOURCE);
...
//            .set(WANT_AST, true)
    ...
    public MdCachedFileElementsTest() {
