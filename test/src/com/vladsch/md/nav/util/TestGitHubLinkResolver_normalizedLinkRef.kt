...
class TestGitHubLinkResolver_normalizedLinkRef constructor(val rowId: Int
    ...
    val linkRef = LinkRef(containingFileRef, linkAddress, null, null, false)
    val normalizedRef = LinkRef(containingFileRef, normalizedAddress, null, null, false)
    val linkWithAnchorRef = LinkRef(containingFileRef, linkAddress, "anchor", null, false)
    val normalizedWithAnchorRef = LinkRef(containingFileRef, normalizedAddress, "anchor", null, false)
