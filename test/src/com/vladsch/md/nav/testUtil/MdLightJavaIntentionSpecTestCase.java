...
public abstract class MdLightJavaIntentionSpecTestCase extends MdLightJavaActionSpecTestCase implements MdLightFixtureIntentionSpecTest {
    ...
    public MdLightJavaIntentionSpecTestCase(@Nullable Map<String, ? extends DataHolder> optionMap, @Nullable DataHolder... defaultOptions) {
