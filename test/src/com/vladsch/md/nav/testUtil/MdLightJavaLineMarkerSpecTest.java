...
public abstract class MdLightJavaLineMarkerSpecTest extends MdLightJavaCodeInsightFixtureSpecTestCase implements MdLightFixtureLineMarkerSpecTest {
    ...
    public MdLightJavaLineMarkerSpecTest(@Nullable Map<String, ? extends DataHolder> optionMap, @Nullable DataHolder... defaultOptions) {
