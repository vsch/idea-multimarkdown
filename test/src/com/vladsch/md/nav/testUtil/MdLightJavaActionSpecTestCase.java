...
public abstract class MdLightJavaActionSpecTestCase extends MdLightJavaCodeInsightFixtureSpecTestCase implements MdLightFixtureActionSpecTest {
    ...
    public MdLightJavaActionSpecTestCase(@Nullable Map<String, ? extends DataHolder> optionMap, @Nullable DataHolder... defaultOptions) {
