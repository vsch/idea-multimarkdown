...
public abstract class MdJavaCodeInsightFixtureSpecTestCase extends JavaCodeInsightFixtureSpecTestCase implements MdCodeInsightFixtureSpecTestCase {
    // standard options
    ...
    public MdJavaCodeInsightFixtureSpecTestCase(@Nullable Map<String, ? extends DataHolder> optionMap, @Nullable DataHolder... defaultOptions) {
