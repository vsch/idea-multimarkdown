...
public abstract class MdLightPlatformLineMarkerSpecTest extends MdLightPlatformCodeInsightFixtureSpecTestCase implements MdLightFixtureLineMarkerSpecTest {
    ...
    public MdLightPlatformLineMarkerSpecTest(@Nullable Map<String, ? extends DataHolder> optionMap, @Nullable DataHolder... defaultOptions) {
